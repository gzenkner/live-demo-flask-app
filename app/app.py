...
def make_picture(training_data_filename, model, new_input_np_arr, output_file):
  ...
  fig.add_trace(go.Scatter(x=new_input_np_arr.reshape(new_input_np_arr.shape[0]), y=new_preds, name='New Outputs', mode='markers', marker=dict(color='purple', size=20, line=dict(color='purple', width=2))))
